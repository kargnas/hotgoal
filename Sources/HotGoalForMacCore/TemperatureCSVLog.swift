...
public final class TemperatureCSVLog {
    ...
    public func record(targetCelsius: Double, actualCelsius: Double, at date: Date = Date()) {
        ...
        do {
            ...
            NSLog("hot-goal-for-mac temperature log write failed: \(error)")
        }
        ...
        do {
            ...
            NSLog("hot-goal-for-mac temperature log cleanup failed: \(error)")
        }
    }
    ...
    public static let defaultDirectoryURL = FileManager.default
        ...
        .appendingPathComponent("Logs/hot-goal-for-mac", isDirectory: true)
