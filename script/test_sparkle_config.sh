...
for file in "$PACKAGER" "$DEV_BUILDER"; do
  ...
  require_text "$file" 'https://github.com/kargnas/hotgoal/releases/latest/download/appcast.xml'
...
require_text "$WORKFLOW" "HotGoal-\$VERSION.dmg"
require_text "$WORKFLOW" "releases/download/\$TAG/HotGoal-\$VERSION.dmg"
